...
puts"seeding games"
g1 = Game.create(title: "Oblivion", platform:"PC, Xbox, PlayStation 3", genre: "Action Role-Playing", theme:"Fantasy", release_date:"March 20, 2006", image_url:"https://upload.wikimedia.org/wikipedia/en/4/4b/The_Elder_Scrolls_IV_Oblivion_cover.png", multiplayer: false, game_description: "Taking place within the fictional province of Cyrodiil, the game's main story focuses on the player character's efforts to thwart a fanatical cult known as the Mythic Dawn that plans to open portal gates to a demonic realm known as Oblivion", developer:"Bethesda Game Studios")
